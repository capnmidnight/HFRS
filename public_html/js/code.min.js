...
!function(i,c,m,l,k){try{i.GoogleAnalyticsObject=m,i[m]=i[m]||function(){(i[m].q=i[m].q||[]).push(arguments)},i[m].l=1*new Date}catch(j){i.hasOwnProperty(d)||(i[d]=function(){})}}(window,document,"ga"),ga("create","UA-51171551-1","auto");ga("send","pageview");
